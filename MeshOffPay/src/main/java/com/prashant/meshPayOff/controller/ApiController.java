package com.prashant.meshPayOff.controller;

import com.prashant.meshPayOff.crypto.ServerKeyHolder;
import com.prashant.meshPayOff.model.*;
import com.prashant.meshPayOff.service.*;
...
public class ApiController {
    ...
    @Autowired private PacketFactoryService packetFactory;
    ...
    /**
     * Creates an encrypted offline payment packet
     * and queues it in the mesh at the given device.
     */
    @PostMapping("/payments/offline")
    public ResponseEntity<?> createOfflinePayment(@RequestBody OfflinePaymentRequest req) throws Exception {
        MeshPacket packet = packetFactory.createPacket(
